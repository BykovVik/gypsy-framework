...
-- ============================================================================
-- Client-side character selection and spawning logic
-- ============================================================================
...
local POSITION_UPDATE_INTERVAL = 30000  -- 30 seconds
...
--- Spawn preview ped for character selection (MUST BE BEFORE setupCamera)
local function spawnPreviewPed()
    ...
    charPed = CreatePed(4, model, Config.PedCoords.x, Config.PedCoords.y, 
                        Config.PedCoords.z, Config.PedCoords.w, false, true)
...
--- Setup camera for character selection
...
local function cleanupCharacterSelection()
...
RegisterNetEvent('gypsy-multicharacter:client:spawnPlayer', function(data)
    ...
    local model = data.charinfo.gender == 0 and 
